...
| Python | JavaScript | C | Babel | CSS | HTML5 | Tailwind CSS | Node.js | Bash | Bootstrap | Django | Express | Flask | Git | Kubernetes | Linux |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Materialize | MongoDB | MySQL | Postman | React | Sass | TypeScript | Vagrant | Webpack |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
